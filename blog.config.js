...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SoEasy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '五谷不分四体不勤', // 作者简介
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 4800, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
